    ...
    <section class="w-full flex items-start justify-center p-6 md:p-0 m-0">
        <div class="max-w-7xl w-full px-3 py-2 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div>
                ...
                {{-- Form Pencarian --}}
                {{-- Disesuaikan agar input pencarian mengisi lebar penuh pada layar kecil --}}
                <form action="{{ route('search') }}" method="GET" class="relative w-full md:max-w-md">
                    <input
                    type="text"
                    name="q"
            ...
            <div class="flex justify-center">
                {{-- Tambahkan kelas max-w-full agar gambar responsif --}}
                <img src="{{ asset('images/laptop.png') }}" class="max-w-full h-auto">
            </div>
