            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex mx-8">
                    ...
                    <form id="search-form" action="{{ route('admin.verifikasi') }}" method="GET" class="flex w-64 md:w-80">
                        <input type="text" name="keyword" id="search-input" placeholder="Cari di sini..."
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
                        ...
                        @if ($aplikasi->count() > 0) {{-- Gunakan count() pada koleksi paginated --}}
                            @foreach ($aplikasi as $data)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-center text-gray-900 whitespace-no-wrap">{{ $data['nama_aplikasi'] }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-center text-gray-900 whitespace-no-wrap">{{ $data['nama_pemilik'] }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-center text-gray-900 whitespace-no-wrap">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                                        <div class="flex space-x-2 justify-center">
                                            ...
                                            <button
                                                class="bg-green-500 hover:bg-green-600 text-white text-xs font-bold py-2 px-4 rounded-lg shadow-sm transition duration-200"
                                                data-id="{{ $data['id'] }}"
                                                data-url="{{ route('admin.aplikasi.terima', ['id' => $data['id']]) }}"
                                                onclick="showAcceptPopup(this)">Terima</button>
                                            <button
                                                class="bg-red-700 hover:bg-red-800 text-white text-xs font-bold py-2 px-4 rounded-lg shadow-sm transition duration-200"
                                                data-id="{{ $data['id'] }}"
            ...
            <div class="flex justify-between items-center mt-6">
                ...
                <div class="flex space-x-2">
                    {{-- Tombol Previous --}}
                    <a href="{{ $aplikasi->previousPageUrl() }}"
