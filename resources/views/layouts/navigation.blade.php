            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if(Auth::check())
                    <div class="flex items-center space-x-3 me-3">
                        @if(Auth::user()->avatar)
                            <img src="{{ Auth::user()->avatar }}" alt="Avatar" class="w-6 h-7 rounded-full object-cover">
                        @endif
                    </div>
                @endif
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            @if(Auth::check() && Auth::user()->avatar)
                <div class="flex justify-center mt-2">
                    <img src="{{ Auth::user()->avatar }}" alt="Avatar" class="w-14 h-14 rounded-full object-cover">
                </div>
            @endif
