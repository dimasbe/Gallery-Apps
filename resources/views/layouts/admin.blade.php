...
<head>
    ...
    <style>
        ...
        .bg-custom-topbar-bg { background-color: var(--color-topbar-bg); }
        .bg-custom-main-bg { background-color: var(--color-main-bg); }
...
<body class="flex flex-col min-h-screen bg-custom-main-bg font-sans">
    ...
    <script>
        ...
        sidebarToggle.addEventListener('click', function () {
            ...
            document.querySelectorAll('.sidebar-panel-text').forEach((el) => {
                el.classList.toggle('hidden');
            });
