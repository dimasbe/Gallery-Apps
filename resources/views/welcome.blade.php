    ...
    <section class="">
        <div class="max-w-7xl mx-auto px-2 mt-10">
            ...
            <div class="mx-auto w-fit grid grid-cols-2 md:grid-cols-3 gap-x-20 gap-y-6">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Permainan']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Belanja']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Pendidikan']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Olahraga']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Fashion']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
                ...
                <a href="{{ route('kategori.show_by_nama', ['nama' => 'Kesehatan']) }}" class="w-[300px] mx-auto relative rounded-xl overflow-hidden shadow-md">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="col-span-1 lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{-- Item 1 --}}
                    <div
                        class="bg-gray-100 border border-[#D9D9D9] rounded-xl overflow-hidden shadow-xl p-6 flex flex-col justify-center min-h-[200px]">
                    ...
                    {{-- Item 2 --}}
                    <div
                        class="bg-gray-100 border border-[#D9D9D9] rounded-xl overflow-hidden shadow-xl p-6 flex flex-col justify-center h-full min-h-[300px]">
                        <img src="{{ asset('images/mobilelegends.png') }}" alt="Mobile Legends"
                            class="w-full h-32 object-cover rounded-t-xl">
                        <div class="pt-4">
                            <h3 class="font-semibold text-gray-800 text-sm mb-1">Mobile Legends: Bang Bang</h3>
                            <p class="text-gray-600 text-xs">MOONTON</p>
                            <div class="flex items-center mt-2">
                                <svg class="w-4 h-4 text-yellow-500 fill-current mr-1" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
                                    <path
                                        d="M10 15l-5.878 3.09 1.176-6.545L.587 7.646l6.545-.952L10 1l2.868 5.694 6.545.952-4.765 4.099 1.176 6.545z" />
                                </svg>
                    ...
                    <div
                        class="bg-gray-100 border border-[#D9D9D9] rounded-xl overflow-hidden shadow-xl p-6 flex flex-col justify-center h-full min-h-[300px]">
                        <div class="relative">
                            <img src="{{ asset('images/township.png') }}" alt="Panen!"
